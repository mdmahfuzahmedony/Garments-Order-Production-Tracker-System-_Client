...
import { FaFacebookF, FaInstagram, FaYoutube, FaPhoneAlt, FaClock } from "react-icons/fa";
...
const Footer = () => {
    ...
    return (
        <footer className={`${themeColors.bg} ${themeColors.textMain} pt-16 font-sans`}>
            <div className="max-w-7xl mx-auto px-6 pb-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div className="space-y-6">
                        ...
                        <Link to="/" className="flex items-center gap-2 group">
                            ...
                            <span className="text-3xl font-bold text-white">
                                Garments<span className="font-light text-gray-400">Tracker</span>
                            </span>
                        </Link>
                    ...
                    {/* 2. Quick Links */}
                    <div>
                        <h3 className={`${themeColors.textHeader} text-lg font-bold mb-2`}>Quick Links</h3>
                        <div className={`h-0.5 w-12 ${themeColors.accentBg} mb-6`}></div> {/* Underline Separator */}
                    ...
                    {/* 3. Useful Links */}
                    <div>
                        <h3 className={`${themeColors.textHeader} text-lg font-bold mb-2`}>Useful Links</h3>
                        <div className={`h-0.5 w-12 ${themeColors.accentBg} mb-6`}></div> {/* Underline Separator */}
                    ...
                    <div>
                        <h3 className={`${themeColors.textHeader} text-lg font-bold mb-2`}>Make Appointment</h3>
                        <div className={`h-0.5 w-12 ${themeColors.accentBg} mb-6`}></div> {/* Underline Separator */}
                        ...
                        {/* Call Us Box */}
                        <div className={`${themeColors.darkBox} p-4 flex items-center gap-4`}>
                            <div className={`w-10 h-10 ${themeColors.accentBg} flex items-center justify-center text-[#03131E] text-lg`}>
                                <FaPhoneAlt />
                            </div>
                            <div>
                                <p className="text-white font-bold text-sm">Call Us Today</p>
                                <p className={`${themeColors.textMain} text-sm font-semibold hover:text-white transition`}>
                                    (+62) 81 589 2581
                                </p>
                            </div>
                        </div>
            ...
            <div className={`border-t ${themeColors.border} py-8`}>
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 space-y-4 md:space-y-0">
                    <p>Textile & Garment Industry WordPress Theme powered by <span className="text-white">Gutenverse Blocks Addons</span></p>
