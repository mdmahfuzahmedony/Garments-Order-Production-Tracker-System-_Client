    ...
    const navOptions = <>
        <li>
            <NavLink 
                to="/" 
                className={({ isActive }) => 
                    `font-bold uppercase text-sm tracking-wide transition-colors duration-300 ${isActive ? "text-[#8CD6B3]" : "text-[#03131E] dark:text-gray-200 hover:text-[#8CD6B3]"}`
                }
            >
                Home
            </NavLink>
                ...
                <div className="navbar max-w-[1500px] mx-auto py-3 md:py-4">
                    ...
                    <div className="navbar-start">
                        ...
                        <div className="dropdown">
                            <label tabIndex={0} className="btn btn-ghost lg:hidden text-[#03131E] dark:text-white pl-0">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" />
                                </svg>
                            </label>
                            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow-lg bg-white dark:bg-gray-800 rounded-box w-52 text-[#03131E] dark:text-gray-200">
                                {navOptions}
                            </ul>
                        </div>
                    ...
                    <div className="navbar-end gap-3 md:gap-4">
                        ...
                        {user ? (
                                ...
                                {isProfileOpen && (
                                    <div className="absolute right-0 mt-4 w-72 bg-white dark:bg-[#0E2A3B] rounded-xl shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden transform transition-all duration-300 z-50 origin-top-right">
                                        ...
                                        <div className="bg-[#03131E] p-5 text-center relative">
                                            ...
                                            <h4 className="text-white font-bold text-lg truncate px-2">{user.displayName || 'User'}</h4>
                            ...
                            <div className="flex items-center gap-3">
                                <Link to="/login" className="hidden md:inline-block font-bold text-sm text-[#03131E] dark:text-white hover:text-[#8CD6B3] transition">
                                    LOGIN
                                </Link>
                                <Link 
                                    to="/register" 
