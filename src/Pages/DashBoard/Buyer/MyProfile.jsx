...
const MyProfile = () => {
  ...
  // ১. ইউজার ডাটা লোড (লজিক অপরিবর্তিত)
  const {
    data: dbUser = {},
    refetch,
    isLoading,
  ...
  // ২. ম্যানেজার রিকোয়েস্ট ফাংশন (লজিক অপরিবর্তিত)
  ...
  return (
    ...
    <div className="w-full min-h-screen p-6 font-sans transition-colors duration-300 relative
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
            ...
            {/* --- Profile Header Card --- */}
            <div className="relative w-full rounded-3xl overflow-hidden shadow-xl bg-white dark:bg-[#151f32] border border-gray-100 dark:border-gray-800 transition-all duration-300">
                ...
                <div className="px-6 pb-6 relative flex flex-col md:flex-row items-center md:items-end -mt-16 md:-mt-12 gap-6">
                    ...
                    <div className="mt-4 md:mt-0">
                        <span className="badge bg-teal-50 text-teal-600 border border-teal-100 dark:bg-teal-900/20 dark:text-teal-400 dark:border-teal-900 badge-lg p-4 font-bold uppercase shadow-sm tracking-wider">
                            {dbUser?.role || "Buyer"}
                        </span>
                    </div>
                </div>
                    ...
                    <div className="card-body">
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-300">
                            <div className="flex items-center gap-4 group">
                                <div className="p-3 bg-orange-50 rounded-xl dark:bg-orange-900/20 group-hover:bg-orange-100 dark:group-hover:bg-orange-900/30 transition-colors">
                                    <FaShoppingBag className="text-orange-500 text-lg" />
                                </div>
                                <div className="flex-1">
                                    <p className="font-bold text-sm text-gray-800 dark:text-white">Total Orders</p>
                                    <p className="text-xs opacity-60">Check My Orders page</p>
                                </div>
                            </div>

                            <div className="flex items-center gap-4 group">
                                <div className="p-3 bg-red-50 rounded-xl dark:bg-red-900/20 group-hover:bg-red-100 dark:group-hover:bg-red-900/30 transition-colors">
                                    <FaMapMarkerAlt className="text-red-500 text-lg" />
                                </div>
                                <div className="flex-1">
                                    <p className="font-bold text-sm text-gray-800 dark:text-white">Address</p>
                                    <p className="text-xs opacity-60 italic">Not set yet</p>
                                </div>
                            </div>

                            <div className="flex items-center gap-4 group">
                                <div className="p-3 bg-purple-50 rounded-xl dark:bg-purple-900/20 group-hover:bg-purple-100 dark:group-hover:bg-purple-900/30 transition-colors">
                                    <FaCalendarAlt className="text-purple-500 text-lg" />
                                </div>
                                <div className="flex-1">
                                    <p className="font-bold text-sm text-gray-800 dark:text-white">Last Login</p>
