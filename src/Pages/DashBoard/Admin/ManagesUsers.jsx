    ...
    <div className="w-full min-h-screen p-6 font-sans transition-colors duration-300 relative
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
             ...
             <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                <div>
                    <p className="text-teal-500 dark:text-teal-400 font-bold tracking-widest uppercase text-xs mb-1">Administration</p>
                    <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white">
                        Manage Users <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-500">({users.length})</span>
                    </h2>
                </div>
            </div>
            ...
            <dialog id="user_modal" className="modal modal-bottom sm:modal-middle backdrop-blur-sm">
                <div className="modal-box bg-white dark:bg-[#151f32] text-gray-800 dark:text-gray-200 border border-gray-100 dark:border-gray-700 shadow-2xl">
                    <h3 className="font-bold text-xl mb-6 text-center border-b border-gray-100 dark:border-gray-700 pb-4">
                        Update User: <span className="text-teal-500">{selectedUser?.name}</span>
                    </h3>
                        ...
                        <form onSubmit={handleUpdateUser} className="space-y-5">
                            ...
                            <div className="form-control w-full">
                                <label className="label pl-0">
                                    <span className="label-text font-bold text-gray-700 dark:text-gray-300">Account Status</span>
                                </label>
                                <select
                                    name="status"
                            ...
                            <div className="form-control w-full">
                                <label className="label pl-0">
                                    <span className="label-text font-bold text-gray-700 dark:text-gray-300">Assign Role</span>
                                </label>
                                <select
                                    name="role"
                            ...
                            <div className="modal-action flex justify-between pt-4">
                                ...
                                <button type="submit" className="btn border-0 text-white bg-gradient-to-r from-teal-400 to-emerald-500 hover:from-emerald-500 hover:to-teal-400 px-8">
                                    Save Changes
                                </button>
                            </div>
                        </form>
